...
4. Tìm hiểu về vùng
- working directory: là vùng chứa các file mới hoặc file có thay đổi
- staging area: Là vùng chứa các file chuẩn bị commit (tạo ra các phiên bản)
- repository: Là vùng chứa các commit (phiên bản)
...
* Các cách thêm file vào vùng staging area:
    Cách 1: Thêm từng file cụ thể:
        git add <file_name>

    Cách 2: Thêm nhiều file cụ thể:
        git add <file_name_1> <file_name_2> <file_name_3> ...

    Cách 3: Thêm tất cả các file:
        git add .
...
* Đặt mỗi repo một tên khác nhau:
...
- Lệnh chạy file JavaScript:
    + Cú pháp: 
        node <tên_file>
            Ví dụ: node hello.js
    + Nếu file nằm trong thư mục sẽ dùng lệnh:
...
- Cách kiểm tra một biến có kiểu dữ liệu gì:
